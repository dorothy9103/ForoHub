...
import com.OracleAlura.ForoHub.domain.respuesta.validaciones.crear.*;
import com.OracleAlura.ForoHub.domain.respuesta.validaciones.actualizar.*;
...
public class RespuestaController {
    ...
    public ResponseEntity<Page<DetalleRespuestaDTO>> leerRespuestaDeTopico(@PageableDefault(size = 5, sort = {"ultimaActualizacion"},
            direction = Direction.ASC)Pageable pageable, @PathVariable Long topicoId){
    ...
    public ResponseEntity<Page<DetalleRespuestaDTO>> leerRespuestasDeUsuarios(@PageableDefault(size = 5, sort = {"ultimaActualizacion"},
            direction = Direction.ASC) Pageable pageable, @PathVariable Long usuarioId){
